...
if ($conn->connect_error) { die("Connection failed: " . $conn->connect_error); }
    ...
    $result = $conn->query($sql1); $nilai1 = 0; 
...
$sql = "SELECT nilai FROM tampung_data_device WHERE nama_alat='sensor_jarak2' ORDER BY id DESC LIMIT 1";
    ...
    <div id="wrapper">
      ...
      >
        ...
        >
          ...
          <div class="sidebar-brand-text mx-3">IOT Dashboard <sup>2</sup></div>
        </a>
                ...
                <div class="card shadow mb-4">
                  ...
                  >
                    <h6 class="m-0 font-weight-bold text-primary">
                      Keuangan Saya Apabila Rebahan Itu Dibayar
                    </h6>
